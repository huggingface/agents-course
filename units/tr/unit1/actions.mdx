# Aksiyonlar: Agenta, Ortamıyla Etkileşim Kurma Yeteneği Kazandırmak
...
Bir Agent için en kritik becerilerden biri, **bir aksiyon tamamlandığında yeni token üretimini DURDURMA yeteneğidir**. Bu, her tür Agent için geçerlidir: JSON, kod veya fonksiyon-çağıran.
...
Aksiyon tamamlandığında, **Agent yeni token üretimini durdurur**. Böylece hatalı veya gereksiz çıktıların önüne geçilir.
