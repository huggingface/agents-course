...
After [signing up](http://hf.co/join/discord), introduce yourself in the `#introduce-yourself` channel and then head over to the `#courses` channel to ask questions, share feedback, and showcase your best agents.
