...
After [signing up](https://discord.com/invite/JfAtkvEtRb), introduce yourself in the `#introduce-yourself` channel and then head over to the `#courses` channel to ask questions, share feedback, and showcase your best agents.
